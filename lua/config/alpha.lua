-- Configuration for 'alpha' plugin
...
local section = {
    ...
    mru_cwd = {
        ...
        val = {
            { type = "padding", val = 1 },
            { type = "text", val = mru_title, opts = { hl = "SpecialComment", shrink_margin = false, position = "center" } },
            { type = "padding", val = 1 },
            {
                type = "group",
                val = function()
